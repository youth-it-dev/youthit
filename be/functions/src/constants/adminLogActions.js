...
const ADMIN_LOG_ACTIONS = {
    ...
    NADAUM_GRANT_FAILED: "NADAUM_GRANT_FAILED", // 나다움 부여 실패 (재시도 큐에 저장됨)
    NADAUM_GRANT_RETRY_SUCCESS: "NADAUM_GRANT_RETRY_SUCCESS", // 나다움 부여 재시도 성공
    NADAUM_GRANT_RETRY_FAILED: "NADAUM_GRANT_RETRY_FAILED", // 나다움 부여 재시도 최종 실패
    NADAUM_RETRY_SCHEDULER_COMPLETED: "NADAUM_RETRY_SCHEDULER_COMPLETED", // 나다움 재시도 스케줄러 완료
    NADAUM_RETRY_SCHEDULER_FAILED: "NADAUM_RETRY_SCHEDULER_FAILED", // 나다움 재시도 스케줄러 실패
