 ...
 * /users/me/all-posts:
 *   get:
 *     summary: 내가 작성한, 좋아요한, 댓글 단 게시글 통합 조회
 *     description: 로그인한 사용자가 작성한, 좋아요한, 댓글 단 게시글을 통합하여 조회합니다. 중복된 게시글은 자동으로 제거됩니다.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         description: 서버 오류
 */
router.get("/me/all-posts", authGuard, userController.getMyAllPosts);
